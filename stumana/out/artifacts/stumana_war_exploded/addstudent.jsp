  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加学生信息</strong> / <small>Personal information</small></div>
      </div>
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" method="post" action="<c:url value="/addstudent.do"/>">
            <div class="am-form-group">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="ssex" id="user-sex" placeholder="输入性别 / Sex">
                <small>性别</small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="date" name="sdate"  id="user-phone" placeholder="输入生日 / Birthday">
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="smajor" id="user-major" placeholder="输入专业">
              </div>
            </div>

            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
                <button type="submit" class="am-btn am-btn-primary">添 加</button>
              </div>
            </div>
              <p><span class="am-comment-danger">${message}</span></p>
          </form>
        </div>
      </div>
    </div>
