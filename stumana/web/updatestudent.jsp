    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改学生信息</strong> / <small>Personal information</small></div>
            </div>
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form class="am-form am-form-horizontal" method="post" action="<c:url value="/updatestudent.do"/>">
                        <input hidden name="sno" value="<%=request.getParameter("sno")%>">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 / Name</label>
                            <div class="am-u-sm-9">
                                <input type="text" required name="sname" value="<%=new String(request.getParameter("sname").getBytes("ISO-8859-1"),"utf-8") %>" id="user-name" placeholder="姓名 / Name">
                                <small>输入你的名字</small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" required name="ssex" value="<%=new String(request.getParameter("ssex").getBytes("ISO-8859-1"),"utf-8")%>" id="user-sex" placeholder="输入性别 / Sex">
                                <small>性别</small>
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="user-phone" class="am-u-sm-3 am-form-label">出生日期 / Date</label>
                            <div class="am-u-sm-9">
                                <input type="date" required name="sdate" value="<%=request.getParameter("sdate")%>"  id="user-phone" placeholder="输入生日 / Birthday">
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="user-major" class="am-u-sm-3 am-form-label">专业 / Major</label>
                            <div class="am-u-sm-9">
                                <input type="text" required name="smajor" value="<%=new String(request.getParameter("smajor").getBytes("ISO-8859-1"),"utf-8")%>" id="user-major" placeholder="输入专业">
                            </div>
                        </div>
